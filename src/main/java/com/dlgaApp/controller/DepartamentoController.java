...
public class DepartamentoController {
	...
	public String departamentoDelete(Model model, @PathVariable("departamentoId") final long departamentoId, HttpServletRequest request) {
	...
	public String asignaturaUpdateModal(@RequestParam(name = "departamentoId") final long departamentoId, Model model,
		...
		for (Profesor p: listaProfesor) {
			opcionesProfesor.put(p.getId().toString(),
					p.getNombre());
	...
	public String departamentoUpdate(@Valid @ModelAttribute("departamentoSeleccionado") Departamento departamento, BindingResult result,
		...
		if (result.hasErrors()) {
			...
			List<Asignatura> asignaturasAntes = this.departamentoService.getDepartamentoById(departamento.getId()).getAsignaturas();
			...
			List<Profesor> profesorAntes = this.departamentoService.getDepartamentoById(departamento.getId()).getProfesores();
	...
	public String departametoCreateGet(
			Model model, HttpServletRequest request) {
	...
	public String departamentoCretePost(@Valid @ModelAttribute("departamentoCreada") Departamento departamento, BindingResult result,
			Model model, HttpServletRequest request) {
